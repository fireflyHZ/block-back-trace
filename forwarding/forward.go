...
func totalRewardInfo(writer http.ResponseWriter, request *http.Request) {
	...
	case "f02420":
		...
		url := fmt.Sprintf("http://172.16.0.7:50001/firefly/profit/total_reward_info?time=%s", t)
	...
	case "f044315":
		...
		url := fmt.Sprintf("http://172.16.0.7:50002/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f055446":
		...
		url := fmt.Sprintf("http://172.16.0.7:50003/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f099132":
		...
		url := fmt.Sprintf("http://172.16.0.7:50005/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f088290":
		...
		url := fmt.Sprintf("http://172.16.0.7:50004/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0104398":
		...
		url := fmt.Sprintf("http://172.16.0.7:50006/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0117450":
		...
		url := fmt.Sprintf("http://172.16.0.7:50007/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0122533":
		...
		url := fmt.Sprintf("http://172.16.0.7:50008/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0130686":
		...
		url := fmt.Sprintf("http://172.16.0.7:50009/firefly/profit/total_reward_info?time=%s", t)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
...
func totalMinerInfo(writer http.ResponseWriter, request *http.Request) {
	...
	case "f02420":
		...
		url := fmt.Sprintf("http://172.16.0.7:50001/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f044315":
		...
		url := fmt.Sprintf("http://172.16.0.7:50002/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f055446":
		...
		url := fmt.Sprintf("http://172.16.0.7:50003/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f099132":
		...
		url := fmt.Sprintf("http://172.16.0.7:50005/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f088290":
		...
		url := fmt.Sprintf("http://172.16.0.7:50004/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0104398":
		...
		url := fmt.Sprintf("http://172.16.0.7:50006/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0117450":
		...
		url := fmt.Sprintf("http://172.16.0.7:50007/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0122533":
		...
		url := fmt.Sprintf("http://172.16.0.7:50008/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
	case "f0130686":
		...
		url := fmt.Sprintf("http://172.16.0.7:50009/firefly/profit/total_miner_info?time=%s&miner=%s", t, miner)
		r, _ := http.NewRequest("GET", url, bytes.NewReader([]byte{}))
		rsp, _ := http.DefaultClient.Do(r)
		rspData, _ := ioutil.ReadAll(rsp.Body)
		writer.Write(rspData)
